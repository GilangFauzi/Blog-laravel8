...
<div class="card mb-3">
   ...
   @if($posts[0]->image)
   {{-- perintah ini guna untuk memaksa gambar agar ukurannya sama --}}
        ...
        <div class="card">
           ...
           @endif
            ...
            <div class="card-body">
              ...
              {{-- untuk menhitung menit posotingan baru --}}
              ...
              <a href="/posts/{{ $post->slug }}" class="text-decoration-none btn btn-success">Read more... </a>
            </div>
            </div>
          </div>
          @endforeach
